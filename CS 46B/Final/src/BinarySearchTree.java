...
{  
   ...
   /**
      Returns the number of nodes where exactly one child is null.
   */
   public int countNodes()
   {
      ...
      return counter = counter + root.countNodes();
   ...
   public static void main(String[] args)
   {
      ...
      String nums = "3754044" + "0123456789";
      for (int i = 0; i < nums.length(); i++)
         t.add(nums.substring(i, i + 1));
      System.out.println(t.countNodes());
   }

   // The tree implementation from the textbook
