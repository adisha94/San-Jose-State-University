...
public class Test2
{
   ...
   public void testRemove1()
   {
      ...
      set.add(new Box(1));
      set.add(new Box(12));
      assertTrue(set.remove(new Box(1))); // remove method as mentioned in the main class
   ...
   public void testRemove2()
   {
      ...
      set.add(new Box(11));
      set.add(new Box(12));
      assertTrue(set.remove(new Box(11))); // remove method as mentioned in the main class
      assertEquals("{2=[12]}", set.buckets.toString());
      assertEquals(1, set.size());
      assertTrue(set.contains(new Box(12)));
   ...
   {
      Set set = new Set(); // set breakpoint     
      Iterator<Object> iter = set.iterator();
      assertFalse(iter.hasNext());
      iter.next();
   }
