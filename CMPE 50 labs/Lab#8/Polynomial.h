...
public:
    ...
    friend Polynomial operator + (const double &regular_num, const Polynomial &polya); // Added in class as per excercise
    friend Polynomial operator + (const Polynomial &polya, const double &regular_num); // Added in class as per excercise
